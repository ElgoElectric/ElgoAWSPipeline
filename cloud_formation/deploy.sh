...
S3_BUCKET=$(echo "elgo-refrigerator-anomaly-prediction-v1-$AWS_ACCOUNT_ID-$AWS_REGION-${ENVIRONMENT}" | tr '[:upper:]' '[:lower:]')
...
INGEST_PIPELINE_STACK_NAME=elgo-refrigerator-anomaly-detection-v1${ENVIRONMENT}
